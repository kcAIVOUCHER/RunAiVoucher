      ...
      <section className="no-print bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-slate-100">
          ...
          <button
            ...
            className="px-6 py-2.5 text-white font-bold text-xs rounded-xl shadow-md hover:shadow-lg disabled:opacity-50 flex items-center gap-2 transition-all shrink-0 cursor-pointer active:scale-[0.99]"
            style={{
      ...
      {!isVoucherReady ? (
        ...
        <>
          ...
          <section className="no-print bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
            ...
            {/* CONTROLS TOOLBAR: Pricing Mode + Fare Family + Classes Toggles */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 pt-2">
              ...
              <div className="space-y-1.5 lg:col-span-6">
                ...
                <div className="grid grid-cols-3 gap-2 bg-slate-100/80 p-1 rounded-xl border border-slate-200">
                  <button
                    ...
                    className={`py-2 px-2 text-xs rounded-lg font-bold transition-all text-center flex items-center justify-center gap-1.5 cursor-pointer ${
              ...
              {/* 2. Fare Family & Booking Class Toggles */}
              <div className="space-y-1.5 lg:col-span-6">
                <label className="text-[11px] font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
                  <ShieldAlert className="w-3.5 h-3.5 text-slate-500" />
                  Visibilidade Tarifária (Aéreo)
                </label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <button
                    ...
                    className={`w-full py-2 px-3 text-xs rounded-xl font-bold border flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            {/* ESTRUTURAÇÃO VISUAL DO MENU DE AÇÕES */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pt-3 border-t border-slate-100">
              {/* Bloco 1: Gestão dos Dados */}
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => setIsEditorOpen(true)}
                  className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-xl border border-slate-200 flex items-center gap-1.5 transition-colors cursor-pointer"
                ...
                <button
                  ...
                  className="px-3 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 text-xs font-bold rounded-xl border border-rose-200 flex items-center gap-1.5 transition-colors cursor-pointer"
              ...
              {/* Bloco 2: Ações de Envio e Finalização */}
              <div className="flex flex-wrap items-center gap-2">
                <button
                  type="button"
                  onClick={handleCopyWhatsApp}
                  className="px-3.5 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-bold rounded-xl border border-emerald-200 flex items-center gap-1.5 transition-colors cursor-pointer"
                ...
                <button
                  type="button"
                  onClick={handleSave}
                  className="px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer shadow-xs"
                  title="Salvar no histórico da agência sem baixar o PDF agora"
                >
                ...
                <button
                  ...
                  className="px-5 py-2 text-white text-xs font-extrabold rounded-xl flex items-center gap-2 transition-all shadow-md hover:shadow-lg active:scale-[0.99] cursor-pointer disabled:opacity-60"
                  style={{
                    backgroundColor: "#00277A"
                  }}
                  title="Salva automaticamente no histórico e baixa o arquivo PDF oficial com quebras automáticas de página"
                >
                  {isGeneratingPdf ? (
                    <>
