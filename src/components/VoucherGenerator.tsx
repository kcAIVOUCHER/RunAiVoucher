            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-slate-100">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-white text-xs font-extrabold rounded-xl flex items-center gap-2 transition-all shadow-md hover:shadow-lg active:scale-[0.99] cursor-pointer disabled:opacity-60"
                  style={{
                    background: "linear-gradient(135deg, #00277A 0%, #152A9D 40%, #16B5F0 100%)",
                  }}
