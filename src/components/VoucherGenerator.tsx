            ...
            >
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2 text-[11px] text-slate-600 font-medium flex-wrap">
                  ...
                  <span className="bg-white px-2.5 py-0.5 rounded-lg border border-slate-200 text-slate-700 font-semibold">
                    ✈️ Tarifas: {currentVoucher.hideFareFamily ? "Ocultas" : "Visíveis"}
                  </span>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 space-y-2">
                    ...
                    <div className="space-y-1.5">
                      <button
                        type="button"
                        onClick={() => setCurrentVoucher({ ...currentVoucher, hideFareFamily: !currentVoucher.hideFareFamily })}
                        className={`w-full py-1.5 px-2 text-[11px] rounded-lg font-bold border flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                      ...
                      >
                        {currentVoucher.hideFareFamily ? (
                          <>
                            <EyeOff className="w-3 h-3 text-purple-600 shrink-0" />
                      ...
                      <button
                        type="button"
                        onClick={() => setCurrentVoucher({ ...currentVoucher, hideBookingClass: !currentVoucher.hideBookingClass })}
                        className={`w-full py-1.5 px-2 text-[11px] rounded-lg font-bold border flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
