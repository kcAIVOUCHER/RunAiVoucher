      ...
      <div style={{ padding: "20px 28px", display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px" }}>
              ...
              <div style={{ textAlign: "right", display: "flex", flexDirection: "column", gap: "2px" }}>
                ...
                <div style={{ fontSize: "11px", color: "#64748b" }}>
                  Voucher nº {voucher.voucherNumber} • Emissão: {voucher.issueDate || new Date().toLocaleDateString("pt-BR")}
                </div>
              </div>
            </div>
          )}
        ...
        >
          <div style={{ fontSize: "10px", color: "#94a3b8", textAlign: "center" }}>
            Voucher nº {voucher.voucherNumber} • Emissão: {voucher.issueDate}
          </div>
