      ...
      <div style={{ padding: "20px 28px", display: "flex", flexDirection: "column", gap: "14px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px" }}>
              ...
              <div style={{ textAlign: "right", display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <div style={{ fontSize: "11px", color: "#64748b" }}>
                  Emissão: {voucher.issueDate || new Date().toLocaleDateString("pt-BR")}
                </div>
              </div>
            </div>
          )}
          ...
          {company && (
            ...
            >
              <span style={{ color: "#64748b", fontWeight: 600 }}>
                Comprovante nº {voucher.voucherNumber} • Emissão: {voucher.issueDate}
              </span>
        ...
        {(voucher.serviceType === "package" || voucher.serviceType === "combo") && (
          ...
          >
            ...
            <span style={{ fontSize: "11px", fontWeight: 600, backgroundColor: "rgba(0,0,0,0.2)", padding: "3px 8px", borderRadius: "4px" }}>
              Serviços Integrados
            </span>
          </div>
        )}

        {/* PASSENGERS SECTION - CLEAN HIGH PRIORITY PRESENTATION */}
        <section
          className="pdf-block-avoid"
          data-pdf-block="true"
          style={{
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "10px" }}>
            ...
            <span style={{ fontSize: "11px", color: "#64748b" }}>
              {voucher.passengers?.length || 1} viajante(s) registrado(s)
            </span>
          </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "11px", color: "#64748b" }}>
                          ...
                          {!voucher.hideBookingClass && flight.bookingClass && <span>Classe: {flight.bookingClass}</span>}
                          {!voucher.hideFareFamily && flight.fareFamily && <span>Tarifa: {flight.fareFamily}</span>}
                        </div>
                      </div>
        ...
        {hotelsList.length > 0 && (
          <section style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#0f172a", fontWeight: 800, fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0284c7" strokeWidth="2.5">
                  <path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z" />
                  <path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2" />
                  <path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2" />
                </svg>
                {hotelsList.length > 1 ? `Hospedagens (${hotelsList.length} Reservas)` : "Hospedagem"}
              </div>
            </div>
                ...
                >
                    ...
                    <div>
                      ...
                      {(hotel.checkInDate || hotel.checkOutDate) && (
                        <div style={{ fontSize: "12px", color: "#64748b", marginTop: "2px", fontWeight: 600 }}>
                          {hotel.checkInDate} → {hotel.checkOutDate} {hotel.nights ? `(${hotel.nights} diárias)` : ""}
                        </div>
                      )}
                    </div>
                  ...
                  >
                    <div>
                      ...
                      <strong style={{ color: "#0f172a", fontSize: "14px" }}>{hotel.checkInDate || "---"}</strong>
                    ...
                    <div>
                      ...
                      <strong style={{ color: "#0f172a", fontSize: "14px" }}>{hotel.checkOutDate || "---"}</strong>
                      <div style={{ fontSize: "11px", color: "#475569", marginTop: "1px" }}>
        ...
        {ticketsList.length > 0 && (
          <section style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#0f172a", fontWeight: 800, fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#7e22ce" strokeWidth="2.5">
                  <path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" />
                </svg>
                {ticketsList.length > 1 ? `Ingressos & Atrações (${ticketsList.length} Itens)` : "Ingresso / Atração"}
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: "12px", color: "#64748b", marginTop: "2px" }}>
                        Tipo: <strong>{ticket.ticketType || "Ingresso Padrão"}</strong> • Data: <strong>{ticket.date} {ticket.time ? `às ${ticket.time}` : ""}</strong>
                      </div>
                    </div>
        ...
        {cruisesList.length > 0 && (
          <section style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", color: "#0f172a", fontWeight: 800, fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0e7490" strokeWidth="2.5">
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ color: "#64748b", marginTop: "1px" }}>{cruise.departureDate}{cruise.departureTime ? ` às ${cruise.departureTime}` : ""}</div>
                    </div>
                    <div>
                      ...
                      <div style={{ color: "#64748b", marginTop: "1px" }}>{cruise.arrivalDate}</div>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ color: "#64748b", marginTop: "2px" }}>{transfer.pickupDateTime}</div>
                    </div>
                    <div>
