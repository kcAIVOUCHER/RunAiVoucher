        ...
        <section className="pdf-block-avoid border border-slate-200 rounded-lg p-4 bg-white" data-pdf-block="true">
          <div className="flex items-center justify-between mb-2.5 pb-2 border-b border-slate-100">
            <div className="flex items-center gap-1.5 text-slate-900 font-bold text-xs uppercase tracking-wider">
              ...
              <span>Passageiro(s) / Hóspede(s)</span>
            </div>
        ...
        {hotelsList.length > 0 && (
          <section className="space-y-3">
            <div className="flex items-center gap-2 text-slate-900 font-bold text-xs uppercase tracking-wider">
              ...
              <span>{hotelsList.length > 1 ? `Hospedagens (${hotelsList.length} Reservas)` : "Hospedagem & Hotel"}</span>
            </div>
                    ...
                    <div>
                      ...
                      {(hotel.checkInDate || hotel.checkOutDate) && (
                        <span className="text-xs font-medium text-slate-600">
                          {hotel.checkInDate} até {hotel.checkOutDate} {hotel.nights ? `(${hotel.nights} diária${hotel.nights > 1 ? 's' : ''})` : ""}
                        </span>
                      )}
                    </div>
        ...
        {carsList.length > 0 && (
          <section className="space-y-3">
            <div className="flex items-center gap-2 text-slate-900 font-bold text-xs uppercase tracking-wider">
              ...
              <span>{carsList.length > 1 ? `Locações (${carsList.length} Veículos)` : "Locação de Veículo"}</span>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs bg-slate-50 p-2.5 rounded-lg">
                    <div>
                      ...
                      <p className="text-slate-600">{car.pickupDate} às {car.pickupTime}</p>
                    </div>
                    <div>
                      ...
                      <p className="text-slate-600">{car.dropoffDate} às {car.dropoffTime}</p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-2">
                    <div>
                      ...
                      <span className="text-xs text-slate-500">Vigência: {ins.startDate} até {ins.endDate}</span>
                    </div>
                    {ins.policyNumber && (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs bg-slate-50 p-2.5 rounded-lg">
                    <div>
                      ...
                      <span className="font-bold text-slate-900">{ticket.date} {ticket.time ? `às ${ticket.time}` : ""}</span>
                    </div>
                    <div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs bg-slate-50 p-2.5 rounded-lg">
                    <div>
                      ...
                      <p className="text-slate-600">{cruise.departureDate} às {cruise.departureTime}</p>
                    </div>
                    <div>
                      ...
                      <p className="text-slate-600">{cruise.arrivalDate}</p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs bg-slate-50 p-2.5 rounded-lg">
                    <div>
                      ...
                      <p className="text-slate-600">{transfer.pickupDateTime}</p>
                    </div>
                    <div>
